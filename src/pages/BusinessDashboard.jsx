  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 py-8">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        {/* Quick Actions */}
        <div className="mb-10">
          {!isPaid && myAds.length >= 1 ? (
            <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">You've reached your free listing limit</h3>
                  <p className="text-gray-600 mb-4">
                    Free users can post 1 wanted ad. Upgrade to Pro for unlimited wanted ads and additional features.
                  </p>
                  <Link
                    to="/pricing"
          ...
          <div className="border-b border-gray-200">
            <nav className="flex space-x-8 px-8">
              <button
                ...
                className={`py-6 px-4 border-b-[3px] font-semibold text-lg transition-all duration-200 ${
                  activeTab === 'ads'
